...
!["Piled Higher and Deeper" by Jorge Cham, http://www.phdcomics.com]({{page.root}}{% link /fig/phd101212s.png %})
...
![]({{page.root}}{%link /fig/play-changes.svg%}){alt='Changes Are Saved Sequentially'}
...
![]({{page.root}}{% link /fig/versions.svg %}){alt='Different Versions Can be Saved'}

Unless multiple users make changes to the same section of the document - a conflict - you can
incorporate two sets of changes into the same base document.

![]({{page.root}}{% link /fig/merge.svg %}){alt='Multiple Versions Can be Merged'}
