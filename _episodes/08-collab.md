...
![]({{page.root}}{% link /fig/github-add-collaborators.png %}){alt='Adding Collaborators on GitHub'}
...
![]({{page.root}}{% link /fig/github-collaboration.svg %}){alt='After Creating Clone of Repository'}
